jQuery ->
  $.template "newChoice", "<div class=\"field choice\"><input id=\"poll_choices_attributes_${count}_content\" name=\"poll[choices_attributes][${count}][content]\" size=\"30\" type=\"text\"><br><input id=\"poll_choices_attributes_${count}_image\" name=\"poll[choices_attributes][${count}][image]\" type=\"file\"> <a href=\"#\" class=\"remove\">[-]</a>"
  $("a.add").live "click", (e) ->
    choice = count: $(".choice").size() + 1
    $.tmpl("newChoice", choice).appendTo "#choices"
